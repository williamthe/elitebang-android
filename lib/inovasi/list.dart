...
import 'package:prototype_litbang/inovasi/view_user.dart';
...
class ListInovasi extends StatefulWidget{
  _ListInovasi createState() => _ListInovasi();

}

class _ListInovasi extends State<ListInovasi>{
...
class _MylistDataState extends State<MylistData> {
  ...
  @override
  Widget build(BuildContext context) {
    final myBodyHeight = MediaQuery.of(context).size.height - MediaQuery.of(context).padding.top -60 ;
