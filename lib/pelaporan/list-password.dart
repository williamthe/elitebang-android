...
import 'package:prototype_litbang/pelaporan/password-baru.dart';
...
class ListPassword extends StatefulWidget{
  String tipe = '';
  ListPassword(String tipe){
    this.tipe = tipe;
  }
  _ListPassword createState() => _ListPassword(tipe);

}

class _ListPassword extends State<ListPassword>{
  String tipe = '';
  _ListPassword(String tipe){
    this.tipe = tipe;
  }
  @override
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Container(padding: EdgeInsetsDirectional.only(start: 10),
                      child: Text('List Password', style: TextStyle(fontFamily: 'Poppins'),)),
                ),
                Expanded(
                  flex: 1,
                  ...
                  children: [
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            child: Text(listDataSrc[index]['username'] == null ? '' : listDataSrc[index]['username'],
                              style: menuText, ),
                            padding: EdgeInsetsDirectional.all(5),
                          ),
                          Text(listDataSrc[index]['password'] == null ? '' : listDataSrc[index]['password'],
                            style: subText, ),
                        ],
                      ),
                    ),
