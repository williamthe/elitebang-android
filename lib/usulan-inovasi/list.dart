...
import 'package:prototype_litbang/usulan-inovasi/form_usulan.dart';
import 'package:prototype_litbang/usulan-inovasi/view_usulan.dart';
import 'package:prototype_litbang/user_menu.dart';
import 'package:http/http.dart' as http;


class ListUsulanInovasi extends StatefulWidget{
  _ListUsulanInovasi createState() => _ListUsulanInovasi();

}

class _ListUsulanInovasi extends State<ListUsulanInovasi>{
                        ...
                        children: [
                          Container(
                            child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(listDataSrc[index]['usulan'] == null ? '' : listDataSrc[index]['usulan'],
                                  style: menuText, ),
                                Text(listDataSrc[index]['status'] == null ? '' : listDataSrc[index]['status'],
                                  style: statusText, ),
                              ],
                            ),
