...
class ListRegulasi extends StatefulWidget{
  _ListRegulasi createState() => _ListRegulasi();

}

class _ListRegulasi extends State<ListRegulasi>{
...
class _MylistDataState extends State<MylistData> {
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Container(padding: EdgeInsetsDirectional.only(start: 10),
                      child: Text('Regulasi', style: TextStyle(fontFamily: 'Poppins'),)),
                ),
                Expanded(
                  flex: 1,
  ...
  getList() async {
    ...
    var response = await http.get(
      Uri.https(env.apiUrl, 'api/regulasi/list'),
      headers: {
        ...
        this.listData = List.generate(listDataSrc.length, (index) => Column(
          children:[
            Container(
              ...
              child: TextButton(
                onPressed: (){
                  launchUrlString('${env.webUrl}/regulasi/${listDataSrc[index]['file']}',
